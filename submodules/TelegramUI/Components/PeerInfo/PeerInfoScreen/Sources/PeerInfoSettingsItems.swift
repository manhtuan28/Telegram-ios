...
func settingsItems(data: PeerInfoScreenData?, context: AccountContext, presentationData: PresentationData, interaction: PeerInfoInteraction, isExpanded: Bool) -> [(AnyHashable, [PeerInfoScreenItem])] {
    ...
    let buildNumber = (Bundle.main.infoDictionary?["CFBundleVersion"] as? String) ?? "3730"
    items[.support]!.append(PeerInfoScreenCommentItem(id: 100, text: "TuanGram for iOS v12.9.2 (\(buildNumber))\nModded Edition"))

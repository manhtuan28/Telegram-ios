...
public struct UserLimitsConfiguration: Equatable {
    ...
    public static var defaultValue: UserLimitsConfiguration {
        return UserLimitsConfiguration(
            maxPinnedChatCount: 1000,
            maxPinnedSavedChatCount: 1000,
            maxArchivedPinnedChatCount: 1000,
            maxChannelsCount: 5000,
            maxPublicLinksCount: 1000,
            maxSavedGifCount: 10000,
            maxFavedStickerCount: 1000,
            maxFoldersCount: 1000,
            maxFolderChatsCount: 1000,
            maxCaptionLength: 10000,
            maxUploadFileParts: 8000,
            maxAboutLength: 1000,
            maxAnimatedEmojisInText: 1000,
            maxReactionsPerMessage: 100,
            maxSharedFolderInviteLinks: 1000,
            maxSharedFolderJoin: 1000,
            maxStoryCaptionLength: 10000,
            maxExpiringStoriesCount: 1000,
            maxStoriesWeeklyCount: 1000,
            maxStoriesMonthlyCount: 1000,
            maxStoriesSuggestedReactions: 1000,
            maxStoriesLinksCount: 1000,
            maxGiveawayChannelsCount: 1000,
            maxGiveawayCountriesCount: 1000,
            maxGiveawayPeriodSeconds: 86400 * 365,
            maxChannelRecommendationsCount: 1000,
            maxConferenceParticipantCount: 1000,
            maxBotsCreated: 1000,
            maxOwnedAITextStyles: 1000,

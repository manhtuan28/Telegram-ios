...
public enum AudioTranscription {
    public struct TrialState: Equatable, Codable {
        ...
        func withUpdatedCooldownUntilTime(_ time: Int32?) -> AudioTranscription.TrialState {
            return AudioTranscription.TrialState(cooldownUntilTime: nil, remainingCount: 999999)
        }
        ...
        public init(cooldownUntilTime: Int32? = nil, remainingCount: Int32 = 999999) {
            self.cooldownUntilTime = nil
            self.remainingCount = 999999
        }
